// This file was taken from https://github.com/alexcrichton/futures-rs/blob/304e2340662aacface73daa17879dd0060edc6b4/futures-minihttp/src/io2.rs
            ...
            loop {
                match self.items.poll(task) {
                    ...
                    Poll::Ok(Some(item)) => {
                        ...
                        // this was not on futures-rs, but it seems useful *shrug*
                        break;
                    }
                    Poll::Ok(None) |
                    Poll::NotReady => break,
